...
/** wa.me click-to-chat URL with the message prefilled. Null if no number. */
export function whatsappLink(whatsappNumber: string | null | undefined, message: string): string | null {
