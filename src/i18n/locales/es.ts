export default {
  translation: {
    ...
    nav: {
      ...
      feeCalculator: 'Calculadora de Cápitas',
      library: 'Biblioteca',
    ...
    feeCalculator: {
      ...
      glSolFee: 'Cápita GL solidaria (período anterior)',
      ...
      presets: {
        ratio: { name: 'Ratio GL', sublabel: 'Mantiene la proporción con la Gran Logia.', termKey: 'ratioGl' },
        base: { name: 'Base', sublabel: 'Sigue la inflación (CVS). Es la referencia contra la que se miden las demás.' },
        gl65: { name: 'GL 65%', sublabel: 'La Gran Logia al 65% de la cápita.', termKey: 'gl65' },
      },
      ...
      glFeeIncrease: 'Incremento GL (referencia CVS)',
      delta: 'GL % de cápita',
      deltaVsGlYearAgo: 'GL % de cápita (hace 1 año)',
      yoyFeeVariation: 'Variación anual de la cápita',
      yoyIndexRef: 'Índice anual (referencia)',
      fetchError: 'No se pudo obtener el CVS del INDEC. Ingresá el CVS trimestral manualmente.',
      manualCvs: 'CVS trimestral % (manual)',
      noCurrentFees: 'No hay cápitas configuradas. Configurá las cápitas primero.',
      noYoyData: 'N/D',

      currentStdFee: 'Cápita estándar actual',
      currentSolFee: 'Cápita solidaria actual',
      activeStdMembers: 'Miembros con cápita estándar',
      activeSolMembers: 'Miembros con cápita solidaria',
      glFeesInMonthlyFees: 'Cápitas Gran Logia (opcional)',
      enterGlFees: 'Ingresá las cápitas GL para ver el ingreso neto.',
    },
