export default {
  translation: {
    ...
    // Monthly Fees
    monthlyFees: {
      title: 'Capita Mensual',
      subtitle: 'Configurar montos de capita para miembros Estándar y Solidarios',
      addMonthlyFees: 'Agregar Capita Mensual',
      setFeeAmounts: 'Establecer los montos de capita para un mes específico',
      selectMonth: 'Seleccionar Mes',
      feesExist: 'La capita para este mes ya existe. Edítala en su lugar.',
      standardFeeAmount: 'Monto Capita Estándar',
      solidarityFeeAmount: 'Monto Capita Solidaria',
      saveFees: 'Guardar Capita',
      feeHistory: 'Historial de Capita',
      monthlyFeeRates: 'Tasas de capita mensual por período',
      noFeesConfigured: 'Aún no hay capita mensual configurada',
      month: 'Mes',
